...
export const sanitizeApiUrl = (url: string): string => {
  ...
  // Replace obsolete hardcoded IP if present
  clean = clean.replace("10.160.81.164", "127.0.0.1");

  // In Expo Go or when hostIp is detected from packager, route to hostIp
